...
function countdown(classname) {
  ...
  var upper = parent.children[0].children[0];
  var upperText = upper.children[0].children[0];
  var upperBack = parent.children[0].children[1];
  var upperBackText = upperBack.children[0].children[0];
  var lower = parent.children[1].children[0];
  var lowerText = lower.children[0].children[0];
  var lowerBack = parent.children[1].children[1];
  var lowerBackText = lowerBack.children[0].children[0];
  upper.style.transform = "rotateX(180deg)";
  lowerBack.style.transform = "rotateX(0deg)";

  if (upperText.innerText - 1 < 0) {
    var nextDecreasing = getNextDecreasingClassname(classname);
...
function getNextDecreasingClassname(currentDecreasing) {
  var classnames = ["second", "minute", "hour", "day"];
  var nextIndex = classnames.indexOf(currentDecreasing);
